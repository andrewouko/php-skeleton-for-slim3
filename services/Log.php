...
class Log{ 
    private $logger;
    private $chanel_name;
    function __construct(string $application_name, string $channel_name, HandlerInterface $handler, $usePsrLogMessageProcessor = false, $useIntrospectionProcessor = false, $useWebProcessor = false, $usePerformanceProcessors = false)
    {
